...
<%		if(session.getAttribute("name")==null || !(session.getAttribute("name").equals(1))){
		...
		if(request.getParameter("purchase1")!=null &&   request.getParameter("purchase1").equals("purchase")){
			request.getRequestDispatcher("./purchase.jsp").forward(request, response);
		}
		System.out.println(request.getParameter("flag1")+"1");
		System.out.println(request.getParameter("flag2")+"2");
		System.out.println(request.getParameter("flag3")+"3");
			...
			<body>
			    ...
			    <div class="content">
			        ...
			        <div class="next">
			            ...
			            <div class='purchase'><input type='submit' name='pervious1' value='previous'></div>
			            
			            <div class='purchase'><input type='submit' name='purchase2' value='purchase'></div>
			        </div>
